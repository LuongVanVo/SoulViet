...
namespace SoulViet.API.Migrations
{
    ...
    [Migration("20260502145931_AddUserAddressTableInPublicSchema")]
    partial class AddUserAddressTableInPublicSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoulViet.Shared.Domain.Entities.LocalPartnerProfile", b =>
                {
                    ...
                    b.ToTable("LocalPartnerProfiles", "public");
                });
            ...
            modelBuilder.Entity("SoulViet.Shared.Domain.Entities.UserAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SoulViet.Shared.Domain.Entities.LocalPartnerProfile", b =>
                {
                    b.HasOne("SoulViet.Shared.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("SoulViet.Shared.Domain.Entities.LocalPartnerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
